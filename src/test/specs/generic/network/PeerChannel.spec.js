describe('PeerChannel', () => {
    ...
    const count = 1;
    const addr = new WsPeerAddress(Services.DEFAULT, Date.now(), NetAddress.UNSPECIFIED, PublicKey.unserialize(BufferUtils.fromBase64(Dummy.publicKey1)), 1, 'node1.krillcoin.com', 8443, Signature.unserialize(BufferUtils.fromBase64(Dummy.signature1)));
